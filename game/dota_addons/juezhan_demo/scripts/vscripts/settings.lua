...
MAX_LEVEL = 100                          -- What level should we let heroes get to? 英雄最大等级
...
FORCE_PICKED_HERO = "npc_dota_hero_wisp"   -- 是否强制所有玩家选择同一个英雄 -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
...
-------------------------
MAX_WAVE = 1                  -- 总波数
INTERVAL_PER_WAVE = 30         -- 两波之间的时间间隔
ATTACKER_AMOUNT_PER_WAVE = 50  -- 每波的进攻怪数